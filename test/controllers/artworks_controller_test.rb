...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { description: @artwork.description, name: @artwork.name, user_id: @artwork.user_id } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { description: @artwork.description, name: @artwork.name, user_id: @artwork.user_id } }
